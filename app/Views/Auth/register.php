			...
			<div class="card" >
				...
				<div class="card-body" >
					...
					<form action="<?= route_to('register') ?>" method="post" >
						...
						<div class="form-group" >
							<label for="allyCode" ><?= lang('Auth.allyCode') ?></label >
							<input type="text"
							       class="form-control <?php if (session('errors.allyCode')) : ?>is-invalid<?php endif ?>"
							       name="allyCode" placeholder="123-456-789" value="<?= old('allyCode') ?>" >
						</div >

						<div class="form-group" >
							<label for="discordId" ><?= lang('Auth.discordId') ?></label >
							<input type="text"
							       class="form-control <?php if (session('errors.discordId')) : ?>is-invalid<?php endif ?>"
							       name="discordId" placeholder="name#1234" value="<?= old('discordId') ?>" >
						</div >
